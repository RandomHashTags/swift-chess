...
// MARK: File
extension BitBoard {
    public static let fileA:BitBoard = fileH << 7
    public static let fileB:BitBoard = fileH << 6
    public static let fileC:BitBoard = fileH << 5
    public static let fileD:BitBoard = fileH << 4
    public static let fileE:BitBoard = fileH << 3
    public static let fileF:BitBoard = fileH << 2
    public static let fileG:BitBoard = fileH << 1
    public static let fileH:BitBoard = 0b00000001_00000001_00000001_00000001_00000001_00000001_00000001_00000001
}

// MARK: Rank
extension BitBoard {
    public static let rank8:BitBoard = rank1 << 56
    public static let rank7:BitBoard = rank1 << 48
    public static let rank6:BitBoard = rank1 << 40
    public static let rank5:BitBoard = rank1 << 32
    public static let rank4:BitBoard = rank1 << 24
    public static let rank3:BitBoard = rank1 << 16
    public static let rank2:BitBoard = rank1 << 8
    public static let rank1:BitBoard = 0b00000000000000000000000000000000000000000000000000000000_11111111
}

// MARK: Special
extension BitBoard {
    public static let whiteSquares:BitBoard = 0b10101010_01010101_10101010_01010101_10101010_01010101_10101010_01010101
    public static let blackSquares:BitBoard = ~whiteSquares
    public static let backSlash:BitBoard = 0b10000000_01000000_00100000_00010000_00001000_00000100_00000010_00000001
    public static let forwardSlash:BitBoard = 0b00000001_00000010_00000100_00001000_00010000_00100000_01000000_10000000
